...
exports.ckeckNotifily = exports.sign = exports.TAG = void 0;
...
exports.sign = sign;
// 检测通知
const ckeckNotifily = async (page) => {
    if (!(await login(page))) {
        return "";
    }
    ...
    return await (0, puppeteer_1.evalText)(page, "div.user-card span.notify-count");
};
exports.ckeckNotifily = ckeckNotifily;
// 提取网页弹出的消息
