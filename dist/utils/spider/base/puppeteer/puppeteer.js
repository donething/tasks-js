...
exports.evalText = exports.waitForNavNoThrow = exports.pageTimeout = exports.PupOptions = void 0;
...
exports.pageTimeout = 20 * 1000;
/**
 * waitForNavigation 超时而不抛出错误
 *
 * 因为有些页面一直在请求，无法等待完成，所以会超时，此时可以避免抛出错误
 */
const waitForNavNoThrow = async (page, waitUntil = "networkidle0", t = exports.pageTimeout) => {
    try {
